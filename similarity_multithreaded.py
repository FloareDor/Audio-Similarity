...
for j in audio_files:
	...
	arr.append(time)
	arr.append(audio)
path_to_sample = "E:\CS mini projects\Audio_Classification\Data\Test\shameless. - where do we go [No Copyright Music].wav"
...
if __name__ == "__main__":
	...
	for i in range(0,len(arr),3):
		p = threading.Thread(target = solve, args = (i,))
		processes.append(p)
		p.start()
